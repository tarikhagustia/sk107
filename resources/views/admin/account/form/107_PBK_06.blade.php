				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title">
							 PERJANJIAN PEMBERIAN AMANAT SECARA ELETRONIK ON-LINE<br>
							 UNTUK TRANSAKSI KONTRAK DERIVATIF DALAM SISTEM PERDAGANGAN ALTERNATIF<br></div>
					</div>
					<div class="panel-body">
						<form action="index.html" method="post" class="form-horizontal">
							<div class="row">
								<div class="col-sm-6">
									<span><strong>Formulir Nomor : 107.PBK.05.2</strong></span>
								</div>
								<div class="col-sm-6">
									<p class="pull-right">
