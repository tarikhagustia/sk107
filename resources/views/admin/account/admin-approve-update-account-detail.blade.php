              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
<<<<<<< HEAD
                      <input disabled type="text" class="form-control" name="name" id="name" value="{{$order->nama}}">
=======
...
>>>>>>> ebe53c6e9c26021da2bbd66aae2444e0190afc04
							...
							<div class="row">
								<div class="col-sm-8 col-sm-offset-4">
									<div class="form-group">
<<<<<<< HEAD
										<label class="col-sm-3 control-label">Peryataan Kebenaran dan tanggung jawab {{$order->aproval_yes}}<span class="text-danger">*)</span></label>
										<div class="col-sm-9">
...
=======
										...
										<div class="col-sm-9">
												...
												<div class="radio-custom radio-primary">
													<input disabled type="radio" id="aproval_yes" name="approval_yes" value="ya" @if($order->approval_yes == "ya") checked="true" @endif>
>>>>>>> ebe53c6e9c26021da2bbd66aae2444e0190afc04
...
=======
													<input disabled type="radio" id="aproval_no" name="approval_yes" value="tidak" @if($order->approval_yes == "tidak") checked="true" @endif>
>>>>>>> ebe53c6e9c26021da2bbd66aae2444e0190afc04
