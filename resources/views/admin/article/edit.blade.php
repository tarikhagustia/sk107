              ...
              <div class="panel-body">
                ...
                <div class="form-group @if($errors->has('category_id')) has-error @endif">
                  ...
                  <select class="form-control" name="category_id">
                    ...
                    <option value="{{$row->id}}" @if($row->category_id == $post->category_id) selected @endif>{{$row->name}}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group @if($errors->has('content')) has-error @endif">
                  ...
                  {!! Form::textarea('content' , $post->html_content , ['class' => 'form-control', 'id' => 'editor']) !!}
            ...
            <div class="panel">
              ...
              <div class="panel-body">
                <div class="form-group @if($errors->has('photo')) has-error @endif">
                  ...
                  <img src="{{asset('photos/1/small/'.$post->image)}}" id="myPreview" class="img-responsive" alt="">
              </div>
            </div>
            <div class="panel">
              <div class="panel-heading">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  {!! Form::text('keywords', $post->meta_keywords, ['class' => 'form-control']) !!}
                </div>
              </div>
            </div>
          </div>
